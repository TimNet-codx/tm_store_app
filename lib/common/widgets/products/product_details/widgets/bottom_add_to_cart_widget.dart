          ...
          Row(
            children: [
              TCircularIcon(
                ...
                onPressed: (cartItem == null || userId.isEmpty)
                    ? null 
                    : () => ref.read(cartProvider.notifier).decrementProductQuantity(product.id, userId), // ✅ FIX: Use 'userId'
                backgroundColor: TColors.darkGrey,
                width: 40,
                height: 40,
                color: TColors.white,
              ...
              TCircularIcon(
                ...
                onPressed: (cartItem == null || userId.isEmpty)
                    ? null 
                    : () => ref.read(cartProvider.notifier).incrementProductQuantity(product.id, userId), // ✅ FIX: Use 'userId'
                backgroundColor: TColors.black,
                width: 40,
                height: 40,
                color: TColors.white,
