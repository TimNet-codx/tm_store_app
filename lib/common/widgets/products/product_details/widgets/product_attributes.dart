...
import 'package:tm_store_app/common/widgets/chips/choice_chip.dart';
...
class TProductAttributes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
     children: [
       // Selected Product  Attribute Pricing & Description
      TRoundedContainer(
            ...
            Row(
              ...
              // Variation Description 
               const TProductTitleText(
                title: 'This is the Description of the prodcut  and it can go up to max 4 lines.',
                smallSize: true,
                maxLines: 4,
                )
          ],
