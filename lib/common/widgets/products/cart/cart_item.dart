...
class TCartItem extends ConsumerWidget {
  const TCartItem(this.item, {super.key});
  final dynamic item;
    ...
    return Row(
      children: [
        ...
        SizedBox(
          ...
          height: 60,
          child:
              (item?.images != null && item!.images.isNotEmpty && item.images[0].isNotEmpty)
                  ? TRoundedImage(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Flexible(child: TProductTitleText(title: item?.description ?? "", maxLines: 1)),
              // Attributes
              Text.rich(TextSpan(children: [TextSpan(text: 'Color: ', style: Theme.of(context).textTheme.bodySmall), TextSpan(text: 'Green ', style: Theme.of(context).textTheme.bodyLarge), TextSpan(text: 'Size: ', style: Theme.of(context).textTheme.bodySmall), TextSpan(text: 'UK 40', style: Theme.of(context).textTheme.bodyLarge)])),
            ],
          ),
        ),
      ],
