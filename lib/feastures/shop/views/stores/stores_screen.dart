...
class StoresScreen extends StatelessWidget {
 ...
 final dark = THelperFunctions.isDarkMode(context);
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: TAppBar(
          title: Text('Store', style: Theme.of(context).textTheme.headlineMedium!.apply(color: TColors.black),),
          actions: [
            TCartCounterIcon(onPressed: () => Get.to(() => const CartScreen()), iconColor: dark ? TColors.light : TColors.dark,)
          ],
