    ...
    return Form(
      ...
      child: Column(
          ...
          Row(
             children: [
              Expanded(
                ...
                decoration: const InputDecoration(prefixIcon: Icon(Icons.home_outlined), labelText: TTexts.street,),
                    ),
               // child: _buildTextField(Icons.home_outlined, 'Street', isUpdate ? '15 Mark' : '')
                ...
                decoration: const InputDecoration(prefixIcon: Icon(Icons.qr_code_scanner), labelText: TTexts.postalCode,),
                    ),
              ...
              Row(
                ...
                decoration: const InputDecoration(prefixIcon: Icon(Icons.location_city_outlined), labelText: TTexts.city,),
                    ),
                          ),
                        const SizedBox(width: 16),
               Expanded(
                ...
                decoration: const InputDecoration(prefixIcon: Icon(Icons.timeline_outlined), labelText: TTexts.state,),
                    ),
        ...
        TextFormField(
         ...
         decoration: const InputDecoration(prefixIcon: Icon(Icons.public), labelText: TTexts.country,),
            ),  
          const SizedBox(height: TSizes.spaceBtwInputFields,),
          // Terms & conditions
          ...
          child: ElevatedButton(
                onPressed: () => controller.signUpUser(
                    ...
                    street: controller.street.text.trim(), 
                    city: controller.city.text.trim(), 
                    state: controller.state.text.trim(), 
                    postalCode: controller.postalCode.text.trim(),
                  ),   
